...
import torch
import cv2
import random  # Needed for random_crop
...
def prepare_image(path, 
    ...
    image = image.permute(2, 0, 1)  # Should be (channels, height, width)
    return image
...
def crop_for_squares(img, cut=0.1):
    '''
